...
RESULTS_DIR=~/kunanyi/results/experiments/tournament/$PARENT_JOBID/$JOB_DIR
...
python3 -m run_exp.exp_tournament -j $PBS_JOBID -w $SCRATCH_DIR -g $GAMEFORM_ID -r ordinal -e 2 -t 10 -p 'tourney_IVA.strategy_set' -k false -z true -c true -l false
