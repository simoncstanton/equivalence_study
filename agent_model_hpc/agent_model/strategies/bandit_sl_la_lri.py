...
class Bandit_sl_la_lri(Strategy):
    ...
    def __init__(self, strategy, strategy_options):
        ...
        '''
        Bandit Method
        supervised learning learning automata L_r-i
        L_r-p       : Linear reward-inaction
    ...
    def action(self, agent, previous_step) -> int:
        ...
        if len(agent.action_history) == 0:
            ...
            if agent.agent_id == 0:
                ...
                if alt_p0 > p0:
                    # Alt action would have been better - do nothing 
                    pass
