#!/usr/bin/env python3
# file: obs_compile_exp_episode_rewards.py
'''
    obs_compile_exp_episode_rewards

    usage: python -m obs_compile_exp_episode_rewards -j __STR__ -z false -l true
        ...
        nominative key
            eo_ep_r   [experiment observation episode rewards]       
...
def main(argv):
    ...
    obs_utility().eo_ep_r_set_obs_data_start(obs_data)    
    obs_data_summary = obs_utility().retrieve_obs_data_summary(obs_data)
    
    obs_utility().make_ep_r_job_paths(obs_data, obs_data_summary)
    ...
    '''
    obs_utility().ep_r_assemble_agent_terminal_sum(result_set_data, obs_data, obs_data_summary)    
    ...
    '''
    obs_utility().ep_r_assemble_terminal_sum_a_mean(result_set_data, obs_data, obs_data_summary)
    ...
    '''
    obs_utility().ep_r_assemble_terminal_sum_a_mean_e_mean(result_set_data, obs_data, obs_data_summary)
    ...
    '''
    obs_utility().ep_r_assemble_terminal_sum_e_mean(result_set_data, obs_data, obs_data_summary)
    ...
    '''
    obs_utility().ep_r_assemble_terminal_sum_e_mean_a_mean(result_set_data, obs_data, obs_data_summary)
    ...
    obs_utility().eo_ep_r_set_obs_data_end(obs_data, obs_data_summary)
    obs_utility().eo_ep_r_write_obs_data_summary(obs_data, obs_data_summary)
    obs_utility().eo_ep_r_write_obs_journal(obs_data, obs_data_summary)
